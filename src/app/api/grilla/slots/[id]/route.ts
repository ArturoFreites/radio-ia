...
export async function PATCH(request: NextRequest, { params }: { params: Promise<{ id: string }> }): Promise<NextResponse> {
  ...
  if (raw.djAudioActiva !== undefined || raw.djAudioCarpetaId !== undefined || raw.djAudioIntervaloMin !== undefined) {
    const audioActiva = raw.djAudioActiva ?? slot.djAudioActiva;
    const carpetaId =
      raw.djAudioCarpetaId !== undefined ? raw.djAudioCarpetaId : slot.djAudioCarpetaId;
    const intervalo =
      raw.djAudioIntervaloMin !== undefined ? raw.djAudioIntervaloMin : slot.djAudioIntervaloMin;
